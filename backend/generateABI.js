...
const abi = ethers.AbiCoder.defaultAbiCoder().encode(
  ['string'],
  [contractSource]
);

writeFileSync('RentPayABI.json', JSON.stringify(abi, null, 2));
console.log('ABI generated and saved to RentPayABI.json'); 